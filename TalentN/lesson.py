...
# # LESSON 14: FUNCTION SCOPE AND LIFETIME
# # # LAMBDA FUNCTION IS A SINGLE USE, COMPACT AND NAMELESS INSTRUCTION.
# # TO APPLY THAT INSTRUCTION WE USE MAP()
# # filter() gives a boolean check on the instruction.
# # sorted() this is basically like a digital organiser.
